...
class ChatIntegrationTest {
    ...
    void createAndFindChatRoom() {
        // When - 채팅방 생성
        ChatRoom chatRoom = chatService.createChatRoom(match.getId());
        ...
        // When - 매치 기반 채팅방 조회
        ChatRoom foundChatRoom = chatService.findChatRoomByMatchId(match.getId());
    ...
    void preventDuplicateChatRoomCreation() {
        ...
        ChatRoom chatRoom1 = chatService.createChatRoom(match.getId());
        ChatRoom chatRoom2 = chatService.createChatRoom(match.getId());
